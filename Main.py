...
pb = Pushbullet("o.YDiGzZoenRspDWAhbGMOSkv41GjO0G0g")
...
def update_graph():
    ...
    while True:
        if timestamps:
            ...
            plt.draw()
            plt.pause(1)
            csv_file.flush()  # Flush the data to the CSV file
            time.sleep(1)  # Add a delay to control the update frequency
            ...
            if ci != -1:
                ...
                if moments['m00'] != 0:
                    ...
                    if centr[1] > threshold:
                        ...
                        pb.push_note("Water Overflow Detected", "The water level has exceeded the threshold.")
                    else:
